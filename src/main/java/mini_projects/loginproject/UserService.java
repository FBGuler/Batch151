...
public class UserService {
    ...
    public void register(){
        ...
        boolean existEmail;
        do {
            System.out.println("Emailninizi giriniz :");
        ...
        System.out.println("Tebrikler kayit islemi gerceklestirildi. ");
    ...
    public void login (){
        Scanner scanner = new Scanner(System.in);
        System.out.println("Kullanici adi veya password giriniz.");
    ...
    public static boolean validatePassword(String passwpord){
        boolean isValid;

        boolean space = passwpord.contains(" ");
        boolean lengthGt6 = passwpord.length()>=6;
        boolean existUpper= passwpord.replaceAll("[^A-Z]","").length()>0;
        boolean existLower= passwpord.replaceAll("[^a-z]","").length()>0;
        boolean existDigit = passwpord.replaceAll("[\\D]","").length()>0;
        boolean existSymbol = passwpord.replaceAll("[\\P{Punct}]","").length()>0;
