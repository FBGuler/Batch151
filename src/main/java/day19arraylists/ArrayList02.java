...
public class ArrayList02 {
    ...
    public static void main(String[] args) {
        ...
        //Kisa yoldan bir list olusturmak icin asagidaki list.of() methodu kulllanilabilir.
        ...
        //equals() methodu ayni elemanlar ayni index te old surece true verir. 
        //indexOf(k) yazarsaniz 'k' nin ilk gorunumunu verir
        int r2 = initials.indexOf('k');
        System.out.println("r2 = " + r2);//1

        //lastIndexOf('k') yazarsaniz 'k' nin son gorunumunun indexi ni verir
        int r3 = initials.lastIndexOf('k');
        System.out.println("r3 = " + r3);//4

        //Examle: Bir listedeki tekrarsiz elemanlari concole a yazdiran kodu yaziniz
        ...
        //Example 2: Bir listte hic tekrarli eleman olup olmadigini gosteren kodu yaziniz
        ...
        if (counter == 0) {
            ...
            System.out.println("All element is not unique in the list");
        }
