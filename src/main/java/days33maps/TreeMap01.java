...
public class TreeMap01 {
    ...
    1) TreeMap "tread-safe" ve "syncronized" degildir.
    Note: Map'lerde "multi thread" kullanmaniz gerektiginde sadece HasTable kullanabilirsiniz.
    1)TreeMap ler value lerde null kullanimina musade eder ama key lerde musade etmez.
    3)TreeMap entry leri key lerine gore natural order siiraya koyar.
    ...
    */
    ...
    public static void main(String[] args) {
        ...
        System.out.println("first code = " +( t2-t1));//first code = 947400
        System.out.println("second code = " + (t3-t2));//second code = 106400 daha hizli calisir.
