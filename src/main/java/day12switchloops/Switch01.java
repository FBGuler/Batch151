...
public class Switch01 {
    public static void main(String[] args) {
        ...
        /* Note : "switch" condition parantez icerisinde
        1)String,int,byte, short, char gonderebiliriz.
        2)"switch" condition icerisinde "long, boolean, float, double" kullanilamaz.
         */
