...
public class Lambda01 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(krktrSysBstnBykOlnSil(iller)); //[Van, MUS, MUS, Ordu, Hatay]
        System.out.println();

        System.out.println(hIleBaslayanOrRIleBitenElSil(iller));//[Van, MUS, MUS, Ordu]
        System.out.println();
    ...
    public static List< String > krktrSysBstnBykOlnSil(List<String >iller) {
        System.out.print("4) ");
