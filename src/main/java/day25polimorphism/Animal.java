...
8)"final method" lar Override edilemezler
  "final method" larin body si degistirilemez ama Override ederken method
  body si degistiririz bu bir celiskidir
  Bu yuzden Java "final method" larin Override edilmesine musade etmez.
9)Static methodlar override edilemez. cunku static methodlar ortak methodlardir.
Bir child ortak methodu degistirirse diger child lar bundan etkilenir, bu etkilenme
ummadik sonuclar ortaya cikarabilir.
Bu yuzden Java "static method" larin Override edilmesine musade etmez.
