...
public class OnlineAlisverisSitesi {
    ...
    public static void musteriSecim() {
        ...
        if(urunKodu >= 0 && urunKodu <= urunListesi.size()){
            System.out.println("Lutfen kac adet istediginizi giriniz");
    ...
    private static void odemeYap() {
        ...
        if (date.isEqual(kurulusGunu)){
            ...
            slowPrint("TechPro Alisveris Sitesini Tercih Ettiginiz icin Tesekkurler", 50 );
            System.out.println();
            System.out.println("Toplam Odeme tutariniz : " +odenecekMiktar + " TL");
        }

    }

    public static void slowPrint(String metin, int gecikme) {
