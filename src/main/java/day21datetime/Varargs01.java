...
public class Varargs01 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(topla(5,2,4,3));//14
        System.out.println(topla(5,2));//7
        System.out.println(topla(5));//5
        System.out.println(topla());//0
        System.out.println(topla(76, 89, 45, 67));//277
        getInitials("Ali Can" , "Kemal Han" , "Tuncay Cinar" , "Ibrahim Catal");


    }
    //Example 1 :Toplama islemi yapan bir method olustur.
    //Asagidaki gibi farkli methodlar olusturarak is yapamayiz. Cunku kullanici farkli sayidaki sayilari toplamak isteyebilir,
